...
extern "C" void app_main(void) {
  tb600b_init_uart((uart_port_t)SO2_UART_PORT, SO2_TX_PIN, SO2_RX_PIN, BAUD_RATE, SO2_UART_TAG);
  tb600b_init_uart((uart_port_t)H2S_UART_PORT, H2S_TX_PIN, H2S_RX_PIN, BAUD_RATE, H2S_UART_TAG);
